...
class K8sNGTemplateDefinition(template_def.BaseTemplateDefinition):
    """Base Kubernetes template."""

    def __init__(self):
        super(K8sNGTemplateDefinition, self).__init__()
    ...
    def get_params(self, context, cluster_template, cluster, **kwargs):
        ...
        return super(K8sNGTemplateDefinition,
