...
def upgrade():
    ...
    op.execute("INSERT INTO cluster_attributes "
               ...
               "node_count) "
               "SELECT "
               "c.cluster_attributes_id, "
               "ct.apiserver_port, "
               "ct.cluster_distro, "
               "ct.coe, "
               "ct.dns_nameserver, "
               "ct.docker_storage_driver, "
               "ct.docker_volume_size, "
               "ct.external_network_id, "
               "ct.fixed_network, "
               "ct.fixed_subnet, "
               "ct.flavor_id, "
               "ct.floating_ip_enabled, "
               "ct.http_proxy, "
               "ct.https_proxy, "
               "ct.image_id, "
               "ct.insecure_registry, "
               "ct.labels, "
               "ct.master_flavor_id, "
               "ct.master_lb_enabled, "
               "ct.network_driver, "
               "ct.no_proxy, "
               "ct.registry_enabled, "
               "ct.server_type, "
    ...
    with op.batch_alter_table("cluster_template") as batch_op:
        batch_op.drop_column('apiserver_port')
        batch_op.drop_column('cluster_distro')
        batch_op.drop_column('coe')
        batch_op.drop_column('dns_nameserver')
        batch_op.drop_column('docker_storage_driver')
        batch_op.drop_column('docker_volume_size')
        batch_op.drop_column('external_network_id')
        batch_op.drop_column('fixed_network')
        batch_op.drop_column('fixed_subnet')
        batch_op.drop_column('flavor_id')
        batch_op.drop_column('floating_ip_enabled')
        batch_op.drop_column('http_proxy')
        batch_op.drop_column('https_proxy')
        batch_op.drop_column('image_id')
        batch_op.drop_column('insecure_registry')
        batch_op.drop_column('keypair_id')
        batch_op.drop_column('labels')
        batch_op.drop_column('master_flavor_id')
        batch_op.drop_column('master_lb_enabled')
        batch_op.drop_column('network_driver')
        batch_op.drop_column('no_proxy')
        batch_op.drop_column('registry_enabled')
        batch_op.drop_column('server_type')
        batch_op.drop_column('tls_disabled')
        batch_op.drop_column('volume_driver')

    with op.batch_alter_table("cluster") as batch_op:
        batch_op.drop_column('create_timeout')
        batch_op.drop_column('discovery_url')
        batch_op.drop_column('keypair')
        batch_op.drop_column('master_count')
